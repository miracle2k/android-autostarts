/**
 * The Android r4 compatibility package works with a special
 * FragmentActivity, which we need to inherit; however, we
 * used to use a ExpandableListActivity, a separate subclass.
 *
 * The compatibility package does not have an answer to this;
 * Fortunately, ExpandableListActivity is quite simple, so I'm
 * just copying the code and creating a version of my own which
 * is inheriting FragmentActivity.
 *
 * See also (including a different approach based on a ListFragment):
 *
